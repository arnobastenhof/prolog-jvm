 ...
 * single pass through a Prolog source program. Implementations may be passed as
 * an argument to a {@link PrologParser} (for the first pass) or to
 * {@link ASTWalker} (for subsequent passes over the constructed {@link Ast}).
 * <p>
...
public interface PrologVisitor<P> {
    ...
    /**
     * Called upon discovery of a clause, before its head and goal literals have
     * been walked.
     */
