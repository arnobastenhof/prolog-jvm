...
/**
 * A parser for a subset of Prolog, based on Covington (1993), ISO Prolog: A
 * Summary of the Draft Proposed Standard.
 * <p>
 * As advocated by Parr (2010) in Language Design Patterns, the semantic actions
 * to be executed during parsing (e.g., for constructing an {@link Ast} are
 * decoupled from the parsing logic itself. In contrast with Parr, however, we
 * achieve this effect not through subclassing, but rather through composition
 * with a {@link PrologVisitor}.
 *
...
public final class PrologParser extends AbstractParser {
    ...
    /**
     * Static factory method for obtaining a new {@link Parser} instance based
     * on the specified {@code input}.
     *
     ...
     * turn being terms built from a functor (possibly of arity 0) and an
     * optional list of term arguments.
     *
     * @throws IOException
     */
    // query = goals, "." ;
