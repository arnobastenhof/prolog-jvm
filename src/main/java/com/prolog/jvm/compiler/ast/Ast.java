...
public final class Ast implements Iterable<Ast> {
     ...
     * list).
     *
     * @param token the token to be stored at this node; not allowed to be null
    ...
    public String toString() {
        ...
        final StringBuilder buffer = new StringBuilder(this.token.getText())
                .append('(');
    ...
    public static final class ASTBuilder {
        ...
        /**
         * Returns an {@link Ast} with a defensive copy of the constructed child
         * list.
         */
        public Ast build() {
