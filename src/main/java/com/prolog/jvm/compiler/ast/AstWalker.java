 ...
 * {@code ParseTreeLister} interface in ANTLR4, discussed in-depth by Parr in
...
public enum AstWalker {
     ...
     *
     * @param root the root node of the AST to be walked; not allowed to be null
     * and must have type {@link TokenType#PROGRAM}
     ...
     * on nodes between their discovery and finishing to the specified
     * {@code visitor}.
     *
    ...
    private void term(final Ast term, final PrologVisitor<Ast> visitor) {
        ...
        case NIL:
            ...
            break;
        default:
            throw new IllegalArgumentException("Could not process " + term
                    + " as a term.");
        }
    }
