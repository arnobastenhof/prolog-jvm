...
public interface StepEvent {
    ...
    /**
     * Returns the address in code memory of the instruction that was executed
     * during this event.
     */
    int getCodeAddress();
    ...
    /**
     * Returns the addresses in the global- and local stack that were written to
     * during this event, either because of variable bindings that were made, or
