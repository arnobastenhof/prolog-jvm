 ...
 * zeroes to the size of a byte. With opcodes occupying only the lower-order six
 * bits of a byte, this allows for the two to be combined at runtime using a
 * bitwise or to arrive at the 'real' instruction to be dispatched on.
 *
...
public final class Instructions {
    ...
    /**
     * Extracts the opcode information from {@code operator} and returns its
     * String representation, in accordance with {@link #opcodeToString(int)}.
     */
