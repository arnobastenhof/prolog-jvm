 ...
 * fields in between steps in order to, say, output debugging information.
 * In other words, the interpreter is implemented as an external iterator,
 * while at the same time being its own (and only) client (via execute).
 */
